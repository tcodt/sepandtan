...
const DEFAULT_IMAGES: ImageItem[] = [
  ...
  {
    src: "/images/athlete-4.jpeg",
    alt: "Athlete 4",
  },
  {
    src: "/images/athlete-5.jpg",
    alt: "Athlete 5",
  },
  {
    src: "/images/athlete-6.jpg",
    alt: "Athlete 6",
  },
  {
    src: "/images/athlete-7.jpg",
    alt: "Athlete 7",
  },
];
  ...
  return (
    <>
      ...
      >
        <main
          ref={mainRef}
          className="absolute inset-0 grid place-items-center overflow-hidden select-none bg-muted"
          style={{
            touchAction: "none",
